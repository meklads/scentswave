...
export const discoverySets: DiscoverySet[] = [
  {
    ...
    sampleIds: ["dior-sauvage-edp", "chanel-bleu-edp", "tom-ford-ombre-leather", "ysl-y-le-parfum", "mancera-red-tobacco"],
    sizeMl: 2,
    offerSAR: 169,
  },
  {
  ...
  },
  {
    ...
    bodyAr: "لانتردي ولا في إيست بيل وآيدول ويوفوريا — للتعرّف قبل الزجاجة.",
    bodyEn: "L'Interdit, La Vie Est Belle, Idôle, and Euphoria — to try before the bottle.",
    sampleIds: ["givenchy-linterdit", "lancome-la-vie-est-belle", "lancome-idole-sample", "ck-euphoria"],
    sizeMl: 2,
    offerSAR: 109,
  },
  {
